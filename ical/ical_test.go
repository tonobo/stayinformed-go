...
func TestRenderCalendar(t *testing.T) {
	...
	calendar := stayinformed.Calendar{Name: "Example", Timezone: "Europe/Berlin", Events: []stayinformed.Event{
		{ID: "timed", Title: "Parents, meeting", Content: "<p>First line</p><p>Second line</p>", Venue: "Room; 1", Start: "2026-09-15T13:00:00", End: "2026-09-15T14:00:00", Modified: "2026-09-11T12:00:00", Groups: []stayinformed.Group{{ID: "group-2", Name: "Class B"}, {ID: "group-1", Name: "Class A"}, {ID: "duplicate", Name: "class a"}}},
	...
	for _, expected := range []string{
		...
		"CATEGORIES:Class A,Class B", "LOCATION:Room\\; 1", "DTSTART;VALUE=DATE:20260916", "DTEND;VALUE=DATE:20260917", "STATUS:CANCELLED",
	} {
